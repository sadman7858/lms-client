...
import Libdetails from '../pages/Libdetails';
import PdfViewer from '../pages/PdfViewer';
import ShowAllUsers from '../pages/ShowAllUsers';
import AddEvents from '../pages/AddEvents';
import EventDlts from '../pages/EventDlts';
import ShowEvntAdmn from '../pages/ShowEvntAdmn';
      ...
      <BrowserRouter>
        <Routes>
          ...
          >
            ...
            <Route
              path='/student/dashbord/pdfViewer/:id'
              element={<PdfViewer />}
            />
            <Route
            ...
            <Route
              path='/student/dashbord/event-dlts'
              element={<EventDlts />}
            ></Route>
            ...
            />
            <Route
              path='/student/dashbord/libdetails'
              element={<Libdetails />}
            />
            <Route
          ...
          >
            ...
            <Route path='/dashbord/addevents' element={<AddEvents />} />
            <Route path='/dashbord/showevn' element={<ShowEvntAdmn />} />
            <Route path='/dashbord/addbook' element={<AddBook />} />
            <Route path='/dashbord/alluser' element={<ShowAllUsers />} />
